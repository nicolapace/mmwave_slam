...
class CANProtocol():
    ...
    @staticmethod
    def EXCDATA_DSB():
        """Dashboard exchange data cmd id"""
        return 9
    @staticmethod
    def EXCDATA_DSB_ACK():
        """Dashboard exchange data ack id"""
        return 10
    @staticmethod
    def SETPIDK_DRV():
        """Driver set pid k cmd id"""
        return 11
    @staticmethod
    def SETPIDK_DRV_ACK():
        """Driver set pid k ack id"""
        return 12
    @staticmethod
    def SETPIDLIM_DRV():
        """Driver set pid limit cmd id"""
        return 13
    @staticmethod
    def SETPIDLIM_DRV_ACK():
        """Driver set pid limit ack id"""
        return 14
    @staticmethod
    def SETDRIVER_DRV():
        """Driver set cmd id"""
        return 15
    @staticmethod
    def SETDRIVER_DRV_ACK():
        """Driver set ack id"""
        return 16
    @staticmethod
    def SET_DSB():
        """Dashboard set cmd id"""
        return 17
    @staticmethod
    def SET_DSB_ACK():
        """Dashboard set ack id"""
        return 18
    @staticmethod
    def SLEEP():
        """Sleep cmd id"""
    ...
    @staticmethod
    def SENDERROR_DRV():
        """Driver send error cmd id"""
        return 23
    @staticmethod
    def SENDERROR_DRV_ACK():
        """Driver send error ack id"""
        return 24
    @staticmethod
    def SETDRIVERLIMIT_DRV_CMD():
        """Driver set limit cmd id"""
        return 27
    @staticmethod
    def SETDRIVERLIMIT_DRV_ACK():
        """Driver set limit ack id"""
        return 28
    @staticmethod
    def DRIVEAIO_DRV():
        """Driver drive aio cmd id"""
        return 29
    @staticmethod
    def DRIVEAIO_DRV_ACK():
        """Driver drive aio ack id"""
        return 30
    @staticmethod
    def HEARTBEAT():
        """Heartbeat cmd id"""
    ...
    @staticmethod
    def MASTER_LOG_DATA():
        """Master log data msg id"""
        return 32
    @staticmethod
    def MASTER_LOG_IMU():
        """Master log imu msg id"""
        return 33
    @staticmethod
    def MASTER_LOG_GENERIC_INFO():
        """Master log generic info msg id"""
        return 34
    @staticmethod
    def INIT_DIAGNOSTIC():
    ...
    @staticmethod
    def STATE_DRV_LEN():
        """Driver state cmd len"""
        return 3
    @staticmethod
    def STATE_DRV_ACK_LEN():
        """State drv ack len"""
        return 5
    @staticmethod
    def DRIVE_DRV_LEN():
    ...
    def STATE_DSB_LEN():
        ...
        return 3
    @staticmethod
    def STATE_DSB_ACK_LEN():
        """Dashboard state len"""
        return 5
    @staticmethod
    def EXCDATA_DSB_LEN():
        """Dashboard exchange data cmd len"""
        return 7
    @staticmethod
    def EXCDATA_DSB_ACK_LEN():
        """Dashboard exchange data ack len"""
        return 16
    @staticmethod
    def SETPIDK_DRV_LEN():
        """Driver set pid k cmd len"""
        return 26
    @staticmethod
    def SETPIDK_DRV_ACK_LEN():
        """Driver set pid k ack len"""
        return 2
    @staticmethod
    def SETPIDLIM_DRV_LEN():
        """Driver set pid limit cmd len"""
        return 10
    @staticmethod
    def SETPIDLIM_DRV_ACK_LEN():
        """Driver set pid limit ack len"""
        return 2
    @staticmethod
    def SETDRIVER_DRV_LEN():
        """Driver set cmd len"""
        return 25
    @staticmethod
    def SETDRIVER_DRV_ACK_LEN():
        """Driver set ack len"""
        return 2
    @staticmethod
    def SET_DSB_LEN():
        """Dashboard set cmd len"""
        return 15
    @staticmethod
    def SET_DSB_ACK_LEN():
        """Dashboard set ack len"""
        return 3
    @staticmethod
    def SLEEP_LEN():
        """Sleep cmd len"""
    ...
    def EXCUDID_ACK_LEN():
        ...
        return 17
    @staticmethod
    def SENDERROR_DRV_LEN():
        """Driver send error cmd len"""
        return 3
    @staticmethod
    def SENDERROR_DRV_ACK_LEN():
        """Driver send error ack len"""
        return 24
    @staticmethod
    def SETDRIVERLIMIT_DRV_CMD_LEN():
        """Driver set limit cmd len"""
        return 28
    @staticmethod
    def SETDRIVERLIMIT_DRV_ACK_LEN():
        """Driver set limit ack len"""
        return 2
    @staticmethod
    def DRIVEAIO_DRV_LEN():
        """Driver drive aio cmd len"""
        return 11
    @staticmethod
    def DRIVEAIO_DRV_ACK_LEN():
        """Driver drive aio ack len"""
        return 15
    @staticmethod
    def HEARTBEAT_LEN():
        """Heartbeat cmd len"""
        return 2
    @staticmethod
    def MASTER_LOG_DATA_LEN():
        """Master log data msg len"""
        return 27
    @staticmethod
    def MASTER_LOG_IMU_LEN():
        """Master log imu msg len"""
        return 27
    @staticmethod
    def MASTER_LOG_GENERIC_INFO_LEN():
        """Master log generic info msg len"""
        return 12
    @staticmethod
